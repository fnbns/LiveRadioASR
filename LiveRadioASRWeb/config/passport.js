...
module.exports = function(passport) {
    ...
    passport.use(new LinkedInStrategy({
        ...
        profileFields: ['id', 'first-name', 'last-name', 'email-address', 'headline', 'network'],
  },
        ...
        process.nextTick(function() {
            ...
            User.findOne({'linkedin.id' : profile.id }, function(err, user) {
                ...
                if (user) {
                    ...
                    newUser.facebook.email = profile._json.emailAddress; // facebook can return multiple emails so we'll take the first
